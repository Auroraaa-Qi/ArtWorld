package auroraaa.yr.library.widgets;
...
public class SrcScrollFrame extends FrameLayout {
    /**
     * 滚动方向
     * 0:往上滚出
     * 1:往下滚出
    ...
    public SrcScrollFrame(@NonNull Context context) {
        this(context, null, 0);
    }

    public SrcScrollFrame(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SrcScrollFrame(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.SrcScrollFrameLayout, defStyleAttr, 0);
        int speed = array.getInteger(R.styleable.SrcScrollFrameLayout_speed, 1);

...
public class D2Fragment extends Fragment {
    ...
    public DashboardItemAdapter adapter2;
    ...
    private void initRecyclerView(){
        ...
        adapter2 = new DashboardItemAdapter(getContext(), list);
        recyclerView.setAdapter(adapter2);
    }

    private void initData(){
        String path = "https://hello-cloudbase-3ga7i4t13018ef95-1305331950.ap-shanghai.service.tcloudbase.com/rest-api/v1.0/baidie";
